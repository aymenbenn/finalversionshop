...
export function ServicePage() {
  ...
  return (
    <div className="w-full pb-20">
      ...
      {/* Service Cards */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-gray-100 flex flex-col">
          ...
          <div className="w-full h-48 bg-gray-200 rounded-2xl mb-6 flex items-center justify-center text-gray-500">
            Vermietung Bild
          </div>
          ...
          <p className="text-gray-600 mb-6 flex-grow">
            Wir suchen ständig neue Standorte zur Miete oder Pacht. Wenn Sie
            eine geeignete Fläche (250 – 450 m²) haben, freuen wir uns auf Ihre
            Kontaktaufnahme.
          </p>
          ...
          <ul className="space-y-3 mb-8">
            ...
            <li className="flex items-center text-gray-700 font-medium">
              <span className="w-2 h-2 bg-orange-600 rounded-full mr-3"></span>
              Flächen von 250 – 450 m²
            </li>

            <li className="flex items-center text-gray-700 font-medium">
              <span className="w-2 h-2 bg-orange-600 rounded-full mr-3"></span>
              Miete oder Pacht möglich
            </li>

            <li className="flex items-center text-gray-700 font-medium">
              <span className="w-2 h-2 bg-orange-600 rounded-full mr-3"></span>
              Standorte in Sachsen & Brandenburg
            </li>
        ...
        <div className="bg-white rounded-3xl p-8 md:p-10 shadow-lg border border-gray-100 flex flex-col">
          ...
          <p className="text-gray-600 mb-6 flex-grow">
            Verschenken Sie Freude! Unsere Geschenkgutscheine sind das perfekte
            Geschenk für jeden Anlass – flexibel einlösbar in allen unseren
            Filialen.
          </p>
          ...
          <button className="w-full py-4 border-2 border-[#2d5a27] text-[#2d5a27] font-bold rounded-xl hover:bg-orange-50 transition-colors flex items-center justify-center">
          ...
          {faqs.map((faq, index) => (
            ...
            >
              ...
              >
                ...
                <span className="font-bold text-[#2d5a27] pr-4">
                  {faq.q}
                </span>
