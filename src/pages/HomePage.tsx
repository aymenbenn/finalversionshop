          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="flex items-center">
                <Link
                  to="/recipes"
                  className="inline-flex items-center justify-center px-8 py-4 bg-green-600 text-white font-bold text-lg rounded-full hover:bg-green-500 shadow-xl transition-all duration-300 transform hover:-translate-y-1 group"
                >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2">
            ...
            <div className="p-10 lg:p-16 flex flex-col justify-center">
              ...
              <p className="text-lg text-gray-600 mb-8">
                Holen Sie sich das Urlaubsfeeling nach Hause! Beim Kauf von einem
                Kasten Corona Extra erhalten Sie jetzt ein exklusives
                Strandtuch <strong className="text-[#FF7F50]">GRATIS</strong> dazu.
              </p>
      ...
      <section className="py-20 bg-orange-50/50">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-12">
            ...
            <img src="/beer.png" alt="Bier" className="w-full h-48 object-cover rounded-xl" />
            <img src="/wein.jpg" alt="Wein & Sekt" className="w-full h-48 object-cover rounded-xl" />
            <img src="/wasser.png" alt="Wasser" className="w-full h-48 object-cover rounded-xl" />
            <img src="/limonaden.jpg" alt="Limonaden" className="w-full h-48 object-cover rounded-xl" />
          ...
          <div className="text-center">
            <Link
              to="/marktfinder"
              className="inline-flex items-center justify-center px-8 py-4 bg-[#FF7F50] text-white font-bold text-lg rounded-full hover:bg-orange-700 shadow-xl transition-all duration-300 transform hover:-translate-y-1"
            >
